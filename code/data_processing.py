...
class eegData:
    ...
    def clean_bad_channels(self, data, channels):
        """
    ...
    def create_alpha_spectrograms
    epoch_type = "alpha"

    f1, f2 = self.get_spectrograms(epoch_type, data, nperseg=2000, noverlap=1000, channels=['O1', 'O2'])


    def get_spectrograms(self, annotation_regexp, nperseg=2000, noverlap=1000, channels=['O1', 'O2']):
        events, eventid = mne.events_from_annotations(self.data, regexp=f'False-{type}.*')
