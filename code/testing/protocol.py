...
class experiment:
    ...
    def exp(self, n=2, full_exp=True):
        ...
        if full_exp:
            conditions = ["alpha-check-closed", "alpha-check-open", "SSVEP", "Motor-Real", "Motor-Imagined", "Laryngeal-Activity-Real", "Laryngeal-Activity-Imagined", "Laryngeal-Modulation-Real", "Laryngeal-Modulation-Imagined"]
        else:
            print("WARNING: \n\t No conditions used. If you meant to run the full experiment, change the value of the full_exp variable from False to True inside of protocol.py.\n\n")
            conditions = ["SSVEP"]
