...
if "PRSNT" in test:
    ...
    epoch_info = PRSNT.present_slide_set(set="Motor-Real", wait_after=False)
    print("Check - Epoch Info: ")
    print(epoch_info)
    PRSNT.present_slide_set(set="elephant-question", elephant_ans=True, wait_after=False)
    epoch_info = PRSNT.present_slide_set(set="Motor-Imagined", wait_after=False)
    print("Check - Epoch Info: ")
    print(epoch_info)
    PRSNT.present_slide_set(set="elephant-question", elephant_ans=False, wait_after=False)
    epoch_info = PRSNT.present_slide_set(set="Laryngeal-Activity-Real", wait_after=False)
    print("Check - Epoch Info: ")
    print(epoch_info)
    PRSNT.present_slide_set(set="elephant-question", elephant_ans=True, wait_after=False)
    epoch_info = PRSNT.present_slide_set(set="Laryngeal-Activity-Imagined", wait_after=False)
    print("Check - Epoch Info: ")
    print(epoch_info)
    PRSNT.present_slide_set(set="elephant-question", elephant_ans=False, wait_after=False)
    epoch_info = PRSNT.present_slide_set(set="Laryngeal-Modulation-Real", wait_after=False)
    print("Check - Epoch Info: ")
    print(epoch_info)
    PRSNT.present_slide_set(set="elephant-question", elephant_ans=True, wait_after=False)
    epoch_info = PRSNT.present_slide_set(set="Laryngeal-Modulation-Imagined", wait_after=False)
    print("Check - Epoch Info: ")
    print(epoch_info)
