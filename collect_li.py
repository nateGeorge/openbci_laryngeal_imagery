...
li_instructions = """at the sound, imagine making a high or low sound according to the screen,
When the sound plays again, stop imaging and rest.
"""
text = visual.TextStim(window, text=li_instructions)
text.draw()
window.flip()
time.sleep(5)
window.flip()
...
stop_stream_save_data(board, times, up_downs, filename='li_exp1')
